...
def band_calculator(color_1, color_2, color_3, color_4):
    ...
    print(band_value)
    return_f_str = f'''
Your resistor is {band_value} Ohms with a tolerance of {band_tolerance[color_4][0]},
which is between {band_value * band_tolerance[color_4][2]} Ohms and {band_value * band_tolerance[color_4][1]} Ohms.'''
    return return_f_str
